class ShoppingCartsController < ApplicationController
  ...
  def add_item_to_cart
    ...
    @cart_id = ShoppingCart.last
    LineItem.create(product_id: @product_id, cart_id: @cart_id ) 
  end
  ...
  def show
    @cart = LineItem.where(cart_id == params[:cart_id])
  ...
  private
    ...
    def shopping_cart_params
      params.require(:shopping_cart).permit(:email)
    end
end
